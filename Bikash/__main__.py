...
async def init():
    ...
    await Bikashh.start()
    try:
        await Bikashh.stream_decall("https://te.legra.ph/file/cc4eaed0a4022178fc98c.jpg")
    except:
        pass
    try:
        await Bikashh.stream_call(
            "https://te.legra.ph/file/cc4eaed0a4022178fc98c.jpg"
        )
    ...
    LOGGER("Bikash").info("find x music Player Started")
    await idle()
